...
{
    const string privateCode = "w6VbzX5vU0ipApdBsm4cYAxyGKS8nYPEqMqjujlPLBCA";  //Key to Upload New Info
    const string publicCode = "6290ff058f40bb11c060377d";   //Key to download
